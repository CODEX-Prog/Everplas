...
var bankId;
var trowId;
jQuery(document).ready(jQuery('#create-payment-method-btn').click(function () {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        if (result['status'] == 'success') {
          ...
          var newRow = paymentMethodTable.row.add([paymentMethod['id'], paymentMethod['name'], "<div>\n" + "</div>"]).draw();
          ...
          buttonWrapper.innerHTML = "<button type=\"button\" class=\"btn btn-sm btn-primary edit-pay-btn\"\n" + "</button>\n" + "<button type=\"button\" class=\"btn btn-sm btn-primary delete-pay-btn\"\n" + "</button>";
          $($(buttonWrapper).children()[0]).attr('id', "edit-pay-".concat(paymentMethod['id'], "-").concat(newRow.index()));
          $($(buttonWrapper).children()[1]).attr('id', "delete-pay-".concat(paymentMethod['id'], "-").concat(newRow.index()));
          ...
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Creat new Payment Method success'
          });
        } else {
          ...
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Create Payment Method Fail'
          });
        }
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        if (result['status'] == 'success') {
          ...
          var newRow = prodCatTable.row.add([productCategory['id'], productCategory['name'], "<div>\n" + "</div>"]).draw();
          console.log('here new row: ', newRow.index());
          var newRowNode = newRow.node();
          $($(newRowNode).children()[2]).addClass('text-center');
          var buttonWrapper = $($(newRowNode).children()[2]).children()[0];
          $(buttonWrapper).addClass('btn-group');
          buttonWrapper.innerHTML = "<button type=\"button\" class=\"btn btn-sm btn-primary edit-pay-btn\"\n" + "</button>\n" + "<button type=\"button\" class=\"btn btn-sm btn-primary delete-pay-btn\"\n" + "</button>";
          $($(buttonWrapper).children()[0]).attr('id', "edit-pay-".concat(productCategory['id'], "-").concat(newRow.index()));
          $($(buttonWrapper).children()[1]).attr('id', "delete-pay-".concat(productCategory['id'], "-").concat(newRow.index()));
          $(buttonWrapper).children()[0].innerHTML = "<i class=\"fa fa-fw fa-pencil-alt\"></i>";
          $(buttonWrapper).children()[1].innerHTML = "<i class=\"fa fa-fw fa-times\"></i>";
          ...
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Creat new Product Category success'
          });
        } else {
          console.log('here create group error: ', result['message']);
          One.helpers('notify', {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        if (result['status'] == 'success') {
          ...
          var newRow = taskCatTable.row.add([taskCategory['id'], taskCategory['name'], "<div>\n" + "</div>"]).draw();
          console.log('here new row: ', newRow.index());
          var newRowNode = newRow.node();
          $($(newRowNode).children()[2]).addClass('text-center');
          var buttonWrapper = $($(newRowNode).children()[2]).children()[0];
          $(buttonWrapper).addClass('btn-group');
          buttonWrapper.innerHTML = "<button type=\"button\" class=\"btn btn-sm btn-primary edit-pay-btn\"\n" + "</button>\n" + "<button type=\"button\" class=\"btn btn-sm btn-primary delete-pay-btn\"\n" + "</button>";
          $($(buttonWrapper).children()[0]).attr('id', "edit-pay-".concat(taskCategory['id'], "-").concat(newRow.index()));
          $($(buttonWrapper).children()[1]).attr('id', "delete-pay-".concat(taskCategory['id'], "-").concat(newRow.index()));
          $(buttonWrapper).children()[0].innerHTML = "<i class=\"fa fa-fw fa-pencil-alt\"></i>";
          $(buttonWrapper).children()[1].innerHTML = "<i class=\"fa fa-fw fa-times\"></i>";
          ...
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Creat new Task Category success'
          });
        } else {
          console.log('here create group error: ', result['message']);
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Create Task Category Fail'
          });
        }
      ...
      error: function error() {
        ...
        One.helpers('notify', {
          type: 'danger',
          icon: 'fa fa-times mr-1',
          message: 'Create Task Category Failed!'
        });
      }
    });
  } else {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        if (result['status'] == 'success') {
          ...
          var newRow = itemCatTable.row.add([itemCategory['id'], itemCategory['name'], "<div>\n" + "</div>"]).draw();
          console.log('here new row: ', newRow.index());
          var newRowNode = newRow.node();
          $($(newRowNode).children()[2]).addClass('text-center');
          var buttonWrapper = $($(newRowNode).children()[2]).children()[0];
          $(buttonWrapper).addClass('btn-group');
          buttonWrapper.innerHTML = "<button type=\"button\" class=\"btn btn-sm btn-primary edit-pay-btn\"\n" + "</button>\n" + "<button type=\"button\" class=\"btn btn-sm btn-primary delete-pay-btn\"\n" + "</button>";
          $($(buttonWrapper).children()[0]).attr('id', "edit-pay-".concat(itemCategory['id'], "-").concat(newRow.index()));
          $($(buttonWrapper).children()[1]).attr('id', "delete-pay-".concat(itemCategory['id'], "-").concat(newRow.index()));
          $(buttonWrapper).children()[0].innerHTML = "<i class=\"fa fa-fw fa-pencil-alt\"></i>";
          $(buttonWrapper).children()[1].innerHTML = "<i class=\"fa fa-fw fa-times\"></i>";
          ...
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Creat new Item Category success'
          });
        } else {
          console.log('here create group error: ', result['message']);
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Create Item Category Fail'
          });
        }
      ...
      success: function success(response) {
        ...
        if (result['status'] == 'success') {
          ...
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Edit Payment Method Success'
          });
        } else {
          ...
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Edit Payment Method Fail'
          });
        }
      },
      error: function error() {
      ...
      success: function success(response) {
        ...
        if (result['status'] == 'success') {
          ...
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Edit Task Category Success'
          });
        } else {
          console.log("here update group error", result['status'], result['message']);
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Edit Task Category Fail'
          });
        }
      },
      error: function error() {
      ...
      success: function success(response) {
        ...
        if (result['status'] == 'success') {
          ...
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Edit Item Category Success'
          });
        } else {
          console.log("here update group error", result['status'], result['message']);
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Edit Item Category Fail'
          });
        }
      },
      error: function error() {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        if (result['status'] == 'success') {
          ...
          var newRow = departmentTable.row.add([department['id'], department['name'], "<div>\n" + "</div>"]).draw();
          console.log('here new row: ', newRow.index());
          var newRowNode = newRow.node();
          $($(newRowNode).children()[2]).addClass('text-center');
          var buttonWrapper = $($(newRowNode).children()[2]).children()[0];
          $(buttonWrapper).addClass('btn-group');
          buttonWrapper.innerHTML = "<button type=\"button\" class=\"btn btn-sm btn-primary edit-pay-btn\"\n" + "</button>\n" + "<button type=\"button\" class=\"btn btn-sm btn-primary delete-pay-btn\"\n" + "</button>";
          $($(buttonWrapper).children()[0]).attr('id', "edit-pay-".concat(department['id'], "-").concat(newRow.index()));
          $($(buttonWrapper).children()[1]).attr('id', "delete-pay-".concat(department['id'], "-").concat(newRow.index()));
          $(buttonWrapper).children()[0].innerHTML = "<i class=\"fa fa-fw fa-pencil-alt\"></i>";
          $(buttonWrapper).children()[1].innerHTML = "<i class=\"fa fa-fw fa-times\"></i>";
          ...
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Creat new Item Department success'
          });
        } else {
          console.log('here create group error: ', result['message']);
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Create Item Department Fail'
          });
        }
      ...
      error: function error() {
        ...
        One.helpers('notify', {
          type: 'danger',
          icon: 'fa fa-times mr-1',
          message: 'Create Item Department Failed!'
        });
      }
    });
  } else {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        if (result['status'] == 'success') {
          ...
          var newRow = bankTable.row.add([bank['id'], bank['name'], "<div>\n" + "</div>"]).draw();
          console.log('here new row: ', newRow.index());
          var newRowNode = newRow.node();
          $($(newRowNode).children()[2]).addClass('text-center');
          var buttonWrapper = $($(newRowNode).children()[2]).children()[0];
          $(buttonWrapper).addClass('btn-group');
          buttonWrapper.innerHTML = "<button type=\"button\" class=\"btn btn-sm btn-primary edit-pay-btn\"\n" + "</button>\n" + "<button type=\"button\" class=\"btn btn-sm btn-primary delete-pay-btn\"\n" + "</button>";
          $($(buttonWrapper).children()[0]).attr('id', "edit-pay-".concat(bank['id'], "-").concat(newRow.index()));
          $($(buttonWrapper).children()[1]).attr('id', "delete-pay-".concat(bank['id'], "-").concat(newRow.index()));
          $(buttonWrapper).children()[0].innerHTML = "<i class=\"fa fa-fw fa-pencil-alt\"></i>";
          $(buttonWrapper).children()[1].innerHTML = "<i class=\"fa fa-fw fa-times\"></i>";
          ...
          One.helpers('notify', {
            type: 'success',
            icon: 'fa fa-check mr-1',
            message: 'Creat new Bank success'
          });
        } else {
          console.log('here create group error: ', result['message']);
          One.helpers('notify', {
...
/***/ 29:
/*!*****************************************************!*\
  !*** multi ./resources/js/pages/setting/setting.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\xampp-new\htdocs\company-erp-laravel\resources\js\pages\setting\setting.js */"./resources/js/pages/setting/setting.js");
