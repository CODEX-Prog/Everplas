...
@section('content')
    ...
    <!-- Page Content -->
    <div class="content">
        <form name="job-create-form" id="job-create-form" action="{{ url('/receiving/job-order') }}" method="post" enctype="multipart/form-data">
            @csrf
            @isset($errors)
                @if ($errors->any())
            ...
            <div class="block">
                ...
                <div class="table-responsive s_table">
                    ...
                    <div class="form-group text-right mr-3">
                        <!-- <button type="submit" class="btn btn-sm btn-primary save-lead-btn pl-4 pr-4 mr-3">
