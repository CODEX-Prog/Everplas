...
@section('content')
    ...
    <!-- Page Content -->
    <div class="content">
        <form name="job-edit-form" id="job-edit-form" action="{{ url('/receiving/job-order') }}" method="post" enctype="multipart/form-data">
            @csrf
            @isset($errors)
                @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-md-6 border-right">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="job-subject" name="job-subject" value="{{ $jo->subject }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="status" name="status">
                                        <option value="Not yet" {{ $jo->status === "Not yet" ? "selected" : ""  }}>Not yet</option>
                                        <option value="In Process" {{ $jo->status === "In Process" ? "selected" : ""  }}>In Progress</option>
                                        <option value="Completed" {{ $jo->status === "Completed" ? "selected" : ""  }}>Completed</option>
                                        <option value="Cancel" {{ $jo->status === "Cancel" ? "selected" : ""  }}>Cancel</option>
                                    </select>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="js-datepicker form-control" id="date" name="date" value="{{ date("d-m-Y", strtotime($jo->start_date)) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="js-datepicker form-control" id="due-date" name="due-date" value="{{ date("d-m-Y", strtotime($jo->due_date)) }}"
                                                   data-week-start="1" data-autoclose="true" data-today-highlight="true" data-date-format="dd/mm/yyyy" placeholder="dd/mm/yyyy">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="amount" name="amount" value="{{ $jo->amount }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="importance" name="importance">
                                                <option value="Urgent" {{ $jo->importance === "Urgent" ? "selected" : ""  }}>Urgent</option>
                                                <option value="Important" {{ $jo->importance === "Important" ? "selected" : ""  }}>Important</option>
                                                <option value="Normal" {{ $jo->importance === "Normal" ? "selected" : ""  }}>Normal</option>
                                                <option value="For Review" {{ $jo->importance === "For Review" ? "selected" : ""  }}>For Review</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" id="description" name="description" class="form-control" rows="2">{{ $jo->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="block">
                ...
                <div class="table-responsive s_table">
                    ...
                    <div class="form-group text-right mr-3">
                        <a href="{{ route('receiving') }}" class="mr-3">
