                ...
                <div class="table-responsive push">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                           ...
                           <!-- {{ $i=0 }} -->
                        @foreach ($jobOrder->materials as $material)
                            <tr>
                            ...
                            <div class="col-md-6 border-right">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="job-subject" name="job-subject"
                                           value="{{ $jobOrder->subject }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="client-id">Select Company or Contact</label>
                                    <input type="text" class="form-control" id="client-id" name="client-id"
                                           value="{{ isset($jobOrder->company_id) ? $jobOrder->company->company_name : $jobOrder->contact->contact_name }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="status">Status</label>
                                    <input type="text" class="form-control" id="status" name="status"
                                           value="{{ $jobOrder->status }}" disabled>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="js-datepicker form-control" id="date" name="date"
                                                   value="{{ $jobOrder->start_date }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="js-datepicker form-control" id="due-date" name="due-date"
                                                   value="{{ $jobOrder->due_date }}" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="amount" name="amount" value="{{ $jobOrder->amount }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="employee-id" name="employee-id"
                                                   value="{{ $jobOrder->employee->full_name }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="importance" name="importance"
                                                   value="{{ $jobOrder->importance }}" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="description">Description / Comments</label>
                                            <textarea type="text" id="description" name="description" class="form-control" rows="2" disabled>{{ $jobOrder->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
