                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <a class="link-fx" href="">New Contact</a>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="content">
        <div class="block">
            ...
            <div class="block-content block-content-full">
                <form name="asset-form" id="asset-form" action="{{ url('/crm/createasset') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @isset($errors)
                        @if ($errors->any())
                    ...
                    <div class="row push col-lg-12 col-x12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="classification">Company</label>
                            ...
                            <div class="form-group">
                                <label for="location">Job Title</label>
                                <input type="text" class="form-control" id="location" name="location" required>
                            </div>
