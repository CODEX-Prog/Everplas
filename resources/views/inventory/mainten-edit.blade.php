                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <a class="link-fx" href="">Edit Maintenance</a>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="content">
        <div class="block">
            ...
            <div class="block-content block-content-full">
                <form name="mainten-form" id="mainten-form" action="{{ url('/inventory/updatemainten') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @isset($errors)
                        @if ($errors->any())
                    ...
                    <div class="row push col-lg-12 col-x12">
                        <div class="col-lg-6 col-x6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="start-date" name="start-date" value="{{ $maintenance->start_date }}" required>
                            </div>
                            <div class="form-group">
                                <label for="end-date">End date</label>
                                <input type="date" class="form-control" id="end-date" name="end-date" value="{{ $maintenance->end_date }}" required>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-lg-6 col-x6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="review-date" name="review-date" value="{{ $maintenance->review_date }}" required>
                            </div>
                            <div class="form-group">
                                <label for="close-date">Close date</label>
                                <input type="date" class="form-control" id="close-date" name="close-date" value="{{ $maintenance->close_date }}" required>
                            </div>
                            <div class="form-group">
                                <label for="10">Report</label>
                            ...
                            <div class="block-content block-content-full mt-4 text-right">
                                <a href="{{ route('inventory.maintens') }}" class="mr-4">
                                    <button type="button" class="btn btn-secondary btn-light pl-3 pr-3">Close</button>
                                </a>
                                <button type="submit" class="btn btn-sm btn-primary ml-4 pl-3 pr-3">
